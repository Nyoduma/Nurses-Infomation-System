...
conn.execute("INSERT INTO patient (patient_id,first_name, sir_name,age, height, weight,bmi,mobile_phone, email,date_of_admission,"
              "condition, current_meds, nursing_care, medical_history,doctor_id, staff_id)\
...
conn.execute("INSERT INTO patient (patient_id, first_name, sir_name, age, height, weight, bmi, mobile_phone, email,date_of_admission,"
              ...
              "'Morning meds administered and patient advised to drink plenty fluids', 'Gout',6,2)");
conn.execute("INSERT INTO patient (patient_id,first_name, sir_name , age, height, weight, bmi,mobile_phone, email,date_of_admission,"
              "condition, current_meds, nursing_care, medical_history,doctor_id, staff_id)\
